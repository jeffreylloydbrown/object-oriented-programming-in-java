/*
 * pUI
 * A Graphical User Interface Library for Processing 2.0
 * http://martinleopold.com/pui
 * 
 * @author      Martin Leopold http://martinleopold.com
 * @modified    10/25/2013
 * @version     0.3 (643)
 * 
...
public final class PUI extends Rect {
	...
	private void welcomeMessage() {
		System.out.println("pUI 0.3 (643) by Martin Leopold http://martinleopold.com");
	}
...
//	}
	...
	public PUI theme(int presetNo) {
		return theme(Theme.preset(presetNo));
	}
	
	public PUI theme(String presetName) {
